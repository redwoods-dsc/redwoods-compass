...
- Replaced old communication questions with two refined ones: "Is there a standard practice for using a central communication platform at the organization?" (focusing on chat/email vs. documentation) and "In addition to communication platforms does your organization or team send out regular company updates from leadership?".
